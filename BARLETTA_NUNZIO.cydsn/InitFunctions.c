...
/*Funzione per inizializzione componenti e flag, settaggio dei control register 1 e 4 di 
...
void SetControlRegister1(void) 
  {
    /*Recupero del frequency rate dalla cella di memoria del EEPROM scelta;
      frequency_rate variabile definita in "InterruptRoutines.h" */
    ...
    /*Scrittura del control register 1;
...
void SetControlRegister4(void)
  {
    /*Scrittura del control register 4;
     La funzione qui presente, è definita in "I2CFunctions.h" ed esplicitata in "I2CFunctions.c"*/
