...
//  #define LIS3DH_OUT_Z_H_ADDRESS 0x2D
  ...
  #define LIS3DH_REG1_L 0b0111 // ora metti solo i bit meno significativi 0x07 settare gli ODR nel MSB 
  #define LIS3DH_REG4_L 0b1000 // ora metti solo i bit meno significativi 0x18, cambiare le fsh e le sensitivuta di conseguenza

  #define LIS3DH_REG4_FS 0b01 //in relazione alla sentività ed alla resolution mode
  #define LIS3DH_SENSITIVITY  2.0 //mg/digit FS: 01 per high resolution mode
  #define LIS3DH_REG4_BLE_BDU 0b00
  #define LIS3DH_REG4_COMPLETE LIS3DH_REG4_L | ((LIS3DH_REG4_FS) | (LIS3DH_REG4_BLE_BDU<<2))<<4
